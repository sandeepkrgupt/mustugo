...
<body class="scrollbar" id="style-6">
	<header>
		<nav class="navbar navbar-default navbar-fixed">
			<div class="container-fluid">
				<div class="row ">
					<div class="col-md-4 shadow"><a href="index.php"><!--img src="images/logo.png" class="logo"-->
  ...
  <!-- Nav tabs -->
	  <ul class="nav nav-tabs force-overflow" role="tablist" style="display: block; position: relative; width: 1600px;">
	    <li role="presentation" class="active"><a href="delhi.php">Delhi</a></li>
  ...
  <!-- Tab panes -->
	...
	<div class="container">
		...
		<div class="col-md-6"></div>
			...
			<div class="col-md-12 text-right"><h5>Delhi<i class="fa fa-users"></i></h5></div>
		</div>
	</div>
	<div class = "container">
